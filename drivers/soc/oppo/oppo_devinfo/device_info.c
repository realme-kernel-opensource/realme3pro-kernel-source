...
sub_mainboard_set:
        ...
        case OPPO_18099:
                ...
                break;
        case OPPO_18621:
                pr_err("sub_mainboard_volt: %d,operator:%d\n", sub_mainboard_volt,operator);
                if ((OPERATOR_RM_FOREIGN == operator) ||(OPERATOR_RM_FOREIGN_INDIA == operator) ||(OPERATOR_RM_FOREIGN_VIETNAM_128GB == operator) ||
		 (OPERATOR_RM_FOREIGN_VIETNAM_64GB == operator) || (OPERATOR_RM_FOREIGN_EUROPE == operator) || (OPERATOR_ALL_CHINA_CARRIER == operator) || (OPERATOR_CHINA_MOBILE == operator)) {
                        snprintf(mainboard_info.manufacture, INFO_BUF_LEN, "rf-match");
                } else {
                        snprintf(mainboard_info.manufacture, INFO_BUF_LEN, "rf-unmatch");
                }
